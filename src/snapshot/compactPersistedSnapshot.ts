import { isRecord } from "../storage/storage";
import type { Distribution, PersistedSkeletonSnapshot } from "../types";
...
export function parsePersistedSnapshot(
	...
	try {
		...
		return compactPersistedSnapshot(parsed as PersistedSkeletonSnapshot);
	} catch {
		return {};
	}
}
